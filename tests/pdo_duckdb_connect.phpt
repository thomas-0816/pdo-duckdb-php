...
$statement = $db->query("SELECT extension_name, loaded, installed FROM duckdb_extensions() WHERE extension_name not in ('autocomplete', 'core_functions', 'inet') and (installed = 1 OR loaded = 1)");
